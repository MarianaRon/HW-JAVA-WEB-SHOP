    ...
    <form class="col s12" method="post">
        ...
        <div class="row">
            <div class="file-field input-field col s6">
                <div class="btn #880e4f pink darken-4">
            ...
            <div class="input-field col s6">
                <button type="button" id="signup-button" class="btn #880e4f pink darken-4 right"><i class="material-icons left">task_alt</i>Реєстрація</button>
            </div>
        </div>
    </form>
</div>
